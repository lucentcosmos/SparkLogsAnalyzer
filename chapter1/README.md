...
public class LogAnalyzerSQL {
  ...
  public static void main(String[] args) {
    ...
    String logFile = args[0];
    JavaRDD<com.databricks.apps.logs.ApacheAccessLog> accessLogs = sc.textFile(logFile)
        .map(com.databricks.apps.logs.ApacheAccessLog::parseFromLogLine);
...
as well if you want to use Spark SQL.
```
...
```
    ...
    ...Copy the code verbatim from [LogAnalyzer.java](java8/src/main/com/databricks/apps/log/LogAnalyzer.java)
    or [LogAnalyzerSQL.java](java8/src/main/com/databricks/apps/log/LogAnalyzerSQL.java)
    that calculates the log statistics.
```

Now that we've walked through the code, run either [LogAnalyzerStreaming.java](java8/src/main/com/databricks/apps/log/LogAnalyzerStreaming.java) now.
or [LogAnalyzerStreamingSQL.java](java8/src/main/com/databricks/apps/log/LogAnalyzerStreamingSQL.java).
...
Run [LogAnalyzerStreamingTotal.java](java8/src/main/com/databricks/apps/log/LogAnalyzerStreamingTotal.java)
now for yourself.
